        ...
        purchaseWIFIButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PaymentRequest paymentRequest = new PaymentRequest()
                        .primaryDescription("OnAir WIFI: 1GB")
                        .secondaryDescription("Usage is valid only for current flight")
                        .amount("$19.90")
                ...
                startActivityForResult(paymentRequest.getIntent(PlaneChat.this), REQUEST_CODE);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                builder.setMessage("Thanks for purchasing SIA OnAir WIFI. You can now start using your WIFI access.")
